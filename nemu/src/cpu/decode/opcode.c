...
instr_func opcode_entry[256] = {
    ...
    /* 0x04 - 0x07*/ add_i2eax_b, add_i2eax_v, inv, inv,
    /* 0x08 - 0x0b*/ or_r2rm_b, or_r2rm_v, or_rm2r_b, or_rm2r_v,
    /* 0x0c - 0x0f*/ or_i2eax_b, or_i2eax_v, inv, opcode_2_byte,
    /* 0x10 - 0x13*/ adc_r2rm_b, adc_r2rm_v, adc_rm2r_b, adc_rm2r_v,
    /* 0x14 - 0x17*/ adc_i2eax_b, adc_i2eax_v, inv, inv,
    /* 0x18 - 0x1b*/ sbb_r2rm_b, sbb_r2rm_v, sbb_rm2r_b, sbb_rm2r_v,
    /* 0x1c - 0x1f*/ sbb_i2eax_b, sbb_i2eax_v, inv, inv,
    /* 0x20 - 0x23*/ and_r2rm_b, and_r2rm_v, and_rm2r_b, and_rm2r_v,
    /* 0x24 - 0x27*/ and_i2eax_b, and_i2eax_v, inv, inv,
    /* 0x28 - 0x2b*/ sub_r2rm_b, sub_r2rm_v, sub_rm2r_b, sub_rm2r_v,
    /* 0x2c - 0x2f*/ sub_i2eax_b, sub_i2eax_v, inv, inv,
    /* 0x30 - 0x33*/ xor_r2rm_b, xor_r2rm_v, xor_rm2r_b, xor_rm2r_v,
    /* 0x34 - 0x37*/ xor_i2eax_b, xor_i2eax_v, inv, inv,
    /* 0x38 - 0x3b*/ cmp_r2rm_b, cmp_r2rm_v, cmp_rm2r_b, cmp_rm2r_v,
    /* 0x3c - 0x3f*/ cmp_i2eax_b, cmp_i2eax_v, inv, inv,
    /* 0x40 - 0x43*/ inc_r_l, inc_r_l, inc_r_l, inc_r_l,
    /* 0x44 - 0x47*/ inc_r_l, inc_r_l, inc_r_l, inc_r_l,
    /* 0x48 - 0x4b*/ dec_r_l, dec_r_l, dec_r_l, dec_r_l,
    /* 0x4c - 0x4f*/ dec_r_l, dec_r_l, dec_r_l, dec_r_l,
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v, mov_rm2sr, inv,
    ...
    /* 0xa8 - 0xab*/ test_i2eax_b, test_i2eax_v, stos_b, stos_v,
    ...
    /* 0xe8 - 0xeb*/ call, jmp_near, ljmp, jmp_short_,
...
instr_func group_1_bv_entry[8] =
    {add_si2rm_v, or_si2rm_v, adc_si2rm_v, sbb_si2rm_v, and_si2rm_v, sub_si2rm_v, xor_si2rm_v, cmp_si2rm_v};
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_c2r_d, inv, mov_r2c_d, inv,
